<div class="container">
  ...
  <section class="area">
    <p>
      SNU Card NewsBot is an automated, personalized slide news service for the
    ...
    <p>
      In this project, my main job was to render news slides from a raw JSON
    ...
    <p>
      <strong>Period</strong> Jan 2017 - May 2017<br />
    ...
    <iframe
      width="560"
      height="315"
      src="https://www.youtube.com/embed/TzF42Ak_B9c"
      frameborder="0"
    ...
    <img
      src="images/snucardnewsbot/snucardnewsbot_api.png"
      class="clean w600"
      alt="The card rendering API for SNU Card News Bot service"
    />
    <p>
      To reduce the system resources for news slide (card) generation, we
    ...
    <img
      src="images/snucardnewsbot/snucardnewsbot_api.png"
      class="clean w600"
      alt="The declarative grammar for SNU Card News Bot service"
    />
    <p>
      A generalizable grammar was viatal to effectively operate the card
    ...
    <h3>Card UI</h3>
    <p>
      Responsive Web design should be aligned with user's journey. An important
    ...
    <h4>Main Page</h4>
    <img
      src="images/snucardnewsbot/snucardnewsbot_ui_1.png"
      class="clean w600"
      alt="The user interface of the main page of SNU Card News Bot service"
    />
    <h4>News Slide Viewer (using slick.js)</h4>
    <img
      src="images/snucardnewsbot/snucardnewsbot_ui_2.png"
      class="clean w600"
      alt="The user interface of the news slide viewer of SNU Card News Bot service"
    />
    <h4>Personalization Setting Page</h4>
    <img
      src="images/snucardnewsbot/snucardnewsbot_ui_3.png"
      class="clean w600"
      alt="The user interface of the personalization setting of SNU Card News Bot service"
    />
    <h4>Personal Archive</h4>
    <img
      src="images/snucardnewsbot/snucardnewsbot_ui_4.png"
      class="clean w600"
      alt="The user interface of the personal archive of SNU Card News Bot service"
    />

    <p />
    <h3>Concept Art</h3>
    <p>
      The contents of news slides were highly political, so using image was not
    ...
    <img
      src="images/snucardnewsbot/snucardnewsbot_concept.png"
      class="clean w600"
      alt="The concept art images for SNU Card News Bot service"
    />
  </section>
</div>
